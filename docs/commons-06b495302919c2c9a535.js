  ...
  [0],
  {
    ...
    234: function(e, t, n) {
      ...
      var f = i.c.nav.withConfig({
          ...
          'box-shadow:0 4px 12px 0 rgba(0,0,0,0.05);height:6rem;display:flex;align-items:center;justify-content:center;background:#5c9c16;',
        ]),
        d = i.c.h1.withConfig({
          ...
          [
            'font-size:1.6rem;font-weight:800;letter-spacing:0.1rem;text-transform:uppercase;margin:0;color:white;',
            '',
          ],
          c.a.phone(s())
        ),
...
//# sourceMappingURL=commons-06b495302919c2c9a535.js.map
